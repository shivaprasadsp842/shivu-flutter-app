        ...
        appBar: AppBar(
          ...
          title:  Row(
            children:[
              ...
              Expanded(
                child: Text('How it Work', style: TextStyle(color: Colors.black,), textAlign: TextAlign.left),
              ),
    ...
    return Column(children: <Widget>[
          ...
          children: <Widget>[
            ...
            new Flexible(
              child:Align(
                alignment: Alignment.centerLeft,
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(45, 10, 10, 0),
                  child:  Container(
                    height: 32.0,
                    // width:200,
                    //padding: const EdgeInsets.fromLTRB(10, 10, 10, 05),
      ...
      Align(
        ...
        child: Container(
          ...
          padding: const EdgeInsets.fromLTRB(40, 0, 45, 10),
          child: Card(
              color: Colors.white,
              child: Padding(

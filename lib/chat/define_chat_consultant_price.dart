...
class DefineChatConsultantPrice extends StatelessWidget {
  DefineChatConsultantPrice({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      ...
      home:Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Define Your Chat Consultation'),
          flexibleSpace: Image(
        ...
        body:const Center(
          child: ChatCOnsultantPriceStatefulWidget(),
        ),
        // home: Scaffold(
...
class ChatCOnsultantPriceStatefulWidget extends StatefulWidget {
  const ChatCOnsultantPriceStatefulWidget({Key? key}) : super(key: key);

  @override
  State<ChatCOnsultantPriceStatefulWidget> createState() => _ChatCOnsultantPriceStatefulWidgetState();
}

class _ChatCOnsultantPriceStatefulWidgetState extends State<ChatCOnsultantPriceStatefulWidget> {
...
// currency
  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      ...
      Container(
        padding: const EdgeInsets.fromLTRB(110.0, 10, 100, 10),
      ...
      Row(
        ...
        children: <Widget>[
          ...
          new Flexible(
            child: new  Container(
              padding: const EdgeInsets.fromLTRB(00, 05, 45, 05),
              //  padding: const EdgeInsets.all(10),
              height: 40.0,
              // width:350,
              child: TextField(
      ...
      Row(
        children: [
          Align(
            alignment: Alignment.centerLeft,
            child: Padding(
              padding: const EdgeInsets.fromLTRB(25, 0, 020, 0),
              child:  Container(
                padding: const EdgeInsets.fromLTRB(10, 0, 020, 05),
                height: 32.0,
                width:150,
                decoration: BoxDecoration(
                  //border: Border.all(color: Colors.black12, width: 1),
          ...
          Align(
            alignment: Alignment.centerLeft,
            child:  Padding(
              padding: const EdgeInsets.fromLTRB(00, 0, 10, 0),
              child:  Container(
                padding: const EdgeInsets.fromLTRB(00, 0, 10, 05),
                height: 32.0,
                width:150,
                decoration: BoxDecoration(
                  //border: Border.all(color: Colors.black12, width: 1),

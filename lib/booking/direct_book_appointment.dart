...
class DirectBookAppointment extends StatelessWidget {
  const DirectBookAppointment({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      //title: 'Video Player Demo',
      home: BookingVideoScreen(),
    );
  }
}

class BookingVideoScreen extends StatefulWidget {
  const BookingVideoScreen({Key? key}) : super(key: key);

  @override
  _BookingVideoScreenState createState() => _BookingVideoScreenState();
}

class _BookingVideoScreenState extends State<BookingVideoScreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child:  Container(
                            padding: const EdgeInsets.fromLTRB(70.0, 15, 70, 15),
                            decoration: BoxDecoration(
                              border: Border.all(color: Colors.black12, width: 1),
                              borderRadius: BorderRadius.circular(05),
                              color: Colors.black12,

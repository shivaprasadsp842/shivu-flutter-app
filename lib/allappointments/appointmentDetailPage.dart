...
import 'package:furniture_ui/allchats/visibility.dart';

import 'appointmentMessageModel.dart';
...
// time hours
  ...
  List<AppointmentMessage> messages = [
    AppointmentMessage(messageContent: "Hi sir, My name Rajiv Talreja, I want to ask some questions regarding my education, Can i take 30 minutes of your time. Please...", messageType: "receiver"),
            ...
            child: Column(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Container(
                    padding: const EdgeInsets.fromLTRB(00, 10, 0, 05),
                    child: Text(
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Container(
                    padding: const EdgeInsets.fromLTRB(0, 5, 0, 05),
                    child: Text(
